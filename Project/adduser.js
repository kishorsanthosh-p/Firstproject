...
const Adding = (props)=>{
    const initialFormState = {id:null,name:"",date:"",status:"",location:"",teamname1:"",teamname2:""}
    ...
    return(<div> 
        ...
        <DialogContentText >
          ...
          <Button onClick={
            event=>{
                if(!users.name||!users.date||!users.location||!users.teamname1||!users.teamname2||!users.status)return;
